    ...
    return (
        <div className="carousel w-full ">
            <div id="slide1" className=" carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute flex h-full items-center left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] w-full">
                    <div className='text-white w-1/2 pl-12'>
                        ...
                        <div>
                            <button className="btn btn-active btn-secondary mr-4">Button</button>
